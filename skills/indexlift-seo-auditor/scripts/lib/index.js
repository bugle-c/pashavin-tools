...
function buildPageSnapshot(page, crawl, options) {
  ...
  return {
    ...
    region_signals: {
      ...
      jsonld_countries: page.parsed.jsonLdRegionSignals?.countries || [],
      jsonld_areas: page.parsed.jsonLdRegionSignals?.areas || [],
      has_jsonld_country: Boolean(page.parsed.jsonLdRegionSignals?.hasJsonLdCountry),
      has_jsonld_area_served: Boolean(page.parsed.jsonLdRegionSignals?.hasJsonLdAreaServed),
    },
